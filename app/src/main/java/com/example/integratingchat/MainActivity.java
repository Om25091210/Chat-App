...
import com.example.integratingchat.ui.FriendsFragment;
import com.example.integratingchat.ui.GroupFragment;
import com.example.integratingchat.ui.LoginActivity;
import com.example.integratingchat.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    boolean get_the_user_once=true;
    String username="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance().getReference().child("user").child(StaticConfig.UID).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(get_the_user_once) {
                    username = snapshot.child("name").getValue(String.class);

                    getSharedPreferences("Saving_Name_of_user", MODE_PRIVATE).edit()
                            .putString("Its_user", username).apply();

                    get_the_user_once=false;
                }
            }
