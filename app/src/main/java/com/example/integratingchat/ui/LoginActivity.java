...
import com.example.integratingchat.MainActivity;
...
import com.example.integratingchat.model.User;
...
public class LoginActivity extends AppCompatActivity {
    ...
    class AuthUtils {
        ...
        void saveUserInfo() {
            ...
            getSharedPreferences("UUID_OF_USER_FROM_FIREBASE", MODE_PRIVATE).edit()
                    .putString("Storing_inside_phone_storoge",StaticConfig.UID).apply();
            ...
            FirebaseDatabase.getInstance().getReference().child("user/" + StaticConfig.UID).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    FirebaseDatabase.getInstance().getReference().child("user/" + StaticConfig.UID).child("DeviceToken").setValue(DeviceToken);
